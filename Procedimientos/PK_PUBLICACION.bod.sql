CREATE OR REPLACE PACKAGE BODY PK_PUBLICACION AS 
    ...
    BEGIN
        ...
        IF lestado_conv = 'PUBLICACION' THEN
            ...
            lf_archivo := UTL_FILE.FOPEN('DIRECTORIO_DE_ARCHIVOS', 'mi_archivo.txt', 'W');
            ...
            FOR lc_solicitudes IN c_solicitudes(pid_convocatoria) LOOP
                UTL_FILE.PUT_LINE(lf_archivo, lc_solicitudes.id_solicitud || CHR(9) || lc_solicitudes.puntaje_total || CHR(9) || lc_solicitudes.nombres || ' ' || lc_solicitudes.apellidos || CHR(9) || lc_solicitudes.nombre);
            END LOOP;
            -- Cerrar el archivo

...
GRANT UPDATE (ESTADO,PUNTAJE_TOTAL, MOTIVO_RECHAZO) ON BIENESTAR.SOLICITUD TO R_ADMIN_VERIFICACION;
...
GRANT UPDATE (ESTADO,OBSERVACION,PUNTAJE_OBTENIDO) ON BIENESTAR.DOCUMENTO TO R_ADMIN_VERIFICACION;

GRANT SELECT ON BIENESTAR.CONDICION TO R_ADMIN_VERIFICACION;
GRANT SELECT ON BIENESTAR.TIPO TO R_ADMIN_VERIFICACION;

GRANT SELECT ON BIENESTAR.TIPO_SUBSIDIO TO R_ADMIN_VERIFICACION;
GRANT SELECT,INSERT ON BIENESTAR.SOLICITUD_APROBADA TO R_ADMIN_VERIFICACION;
GRANT INSERT ON BIENESTAR.CONVOCATORIA TO R_ADMIN_VERIFICACION;
GRANT INSERT ON BIENESTAR.CONVOCATORIA_TIPO_SUBSIDIO TO R_ADMIN_VERIFICACION;
GRANT INSERT ON BIENESTAR.CONVOCATORIA_TIPO TO R_ADMIN_VERIFICACION;
GRANT UPDATE ON BIENESTAR.TIPO TO R_ADMIN_VERIFICACION;
GRANT SELECT ON BIENESTAR.ESTUDIANTE TO R_ADMIN_VERIFICACION;
...
CREATE USER U_ADMIN1 IDENTIFIED BY ADMIN1 DEFAULT TABLESPACE APOYODEF TEMPORARY TABLESPACE APOYOTEMP1 QUOTA 2M ON APOYODEF;
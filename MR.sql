...
/*  Created On : 17-sept.-2023 10:15:26 p. m. 				*/
/*  DBMS       : Oracle 						*/
/* ---------------------------------------------------- */
...
(
	...
	"FECHA" TIMESTAMP NOT NULL,	-- Fecha en la que se realiza la actividad de apoyo
...
(
	...
	"FECHA_I_CONV" TIMESTAMP NOT NULL,	-- Fecha de apertura hacia los estudiantes para aplicar a la convocatoria
	"FECHA_I_INSC" TIMESTAMP NOT NULL,	-- Fecha de inicio de inscripciones por parte de los estudiantes
	"FECHA_I_VERIF" TIMESTAMP NOT NULL,	-- Fecha de inicio de la verificacion de los documentos asociados a una solicitud
...
(
	...
	"FK_ID_SOLICITUD" VARCHAR2(10) NOT NULL,
...
(
	"ID_SOLICITUD" VARCHAR2(10) NOT NULL,	-- Identificador único de cada solicitud de apoyo alimentario.
	"FECHA_CREACION" TIMESTAMP(9) NOT NULL,	-- La fecha y hora en que se creó la solicitud.
	"ESTADO" VARCHAR2(25) NOT NULL,	-- El estado actual de la solicitud, que puede ser "Pendiente," "Aprobada," "Rechazada," u otros estados relevantes.
	"PUNTAJE_TOTAL" NUMBER(3) NOT NULL,	-- El puntaje total obtenido por el estudiante en su solicitud. El puntaje puede estar en el rango de 0 a 100.
	...
	"FK_CODIGO" VARCHAR2(11) NULL,
	"FK_ID_CONVOCATORIA" VARCHAR2(10) NULL,
...
(
	...
	"FK_ID_SOLICITUD" VARCHAR2(10) NULL,
...
(
	...
	"POR_COBERTURA" VARCHAR2(50) NOT NULL,	-- El porcentaje de cobertura del subsidio. Indica cuánto del subsidio total se cubre para este tipo. Puede ser el 100% para "Total," el 70% para "Tipo A," o el 40% para "Tipo B."
